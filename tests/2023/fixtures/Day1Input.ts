export const exampleDocumentCalibratorInput = `1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet`;

export const secondExampleDocumentCalibratorInput = `two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
export const problemDocumentCalibratorInput = `gtlbhbjgkrb5sixfivefivetwosix
